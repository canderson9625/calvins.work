...
// /Users/calvinanderson/dev/docker/dev/calvins.work/node_modules/react/cjs/react.development.js
...
// /Users/calvinanderson/dev/docker/dev/calvins.work/node_modules/react/index.js
...
// /Users/calvinanderson/dev/docker/dev/calvins.work/node_modules/scheduler/cjs/scheduler.development.js
...
// /Users/calvinanderson/dev/docker/dev/calvins.work/node_modules/scheduler/index.js
...
// /Users/calvinanderson/dev/docker/dev/calvins.work/node_modules/react-dom/cjs/react-dom.development.js
...
// /Users/calvinanderson/dev/docker/dev/calvins.work/node_modules/react-dom/index.js
...
// /Users/calvinanderson/dev/docker/dev/calvins.work/node_modules/react-dom/client.js
...
// ts/components/carousel/carousel.tsx
var import_react4 = __toESM(require_react(), 1);

// ts/components/carousel/constants.tsx
var import_react = __toESM(require_react(), 1);
var trackStateTitle;
(function(trackStateTitle2) {
...
})(trackStateTitle || (trackStateTitle = {}));
var actionTypeStates;
(function(actionTypeStates2) {
  actionTypeStates2[actionTypeStates2["Focus"] = 0] = "Focus";
  actionTypeStates2[actionTypeStates2["Hovered"] = 1] = "Hovered";
  actionTypeStates2[actionTypeStates2["Grab"] = 2] = "Grab";
  actionTypeStates2[actionTypeStates2["Release"] = 3] = "Release";
  actionTypeStates2[actionTypeStates2["Move"] = 4] = "Move";
})(actionTypeStates || (actionTypeStates = {}));
...
var CarouselContext = import_react.createContext({
  state: CarouselDefaults,
  dispatch: () => {
  }
});
var Projects = [
  import_react.default.createElement(Project, {
    key: "proj-seed",
    srcSlug: "seed",
  ...
  }, import_react.default.createElement("p", null, "I helped with the responsiveness of the landing page and I built the new blog post template utilizing custom Gutenberg Blocks for a hassle-free backend content management experience.")),
  import_react.default.createElement(Project, {
    key: "proj-brmc",
    srcSlug: "brmc",
  ...
  }, import_react.default.createElement("p", null, "I integrated Loyalty Lion, a Shopify Plus loyalty program into this shopify theme as well as wordpress to handle the blog. This website takes full advantage of Shopify Plus to further enhance and customize the User Experience.")),
  import_react.default.createElement(Project, {
  ...
  }, import_react.default.createElement("p", null, "I enjoyed creating the animations and interactivity on the portfolio page. We used advanced custom fields to give the client the ability to update their staff.")),
  import_react.default.createElement(Project, {
  ...
  }, import_react.default.createElement("p", null, "I created the carousel animation on the Markets page and worked on the timeline on the about.")),
  import_react.default.createElement(Project, {
  ...
  }, import_react.default.createElement("p", null, "I created the filter for the recycle your docks program. I helped make the custom cursor responsive when it used to lag and repaint the cursor every 300ms. I used Stripo to build out email campaigns in Mailchimp.")),
  import_react.default.createElement(Project, {
    key: "proj-vive_psych",
    srcSlug: "vivepsych",
  ...
  }, import_react.default.createElement("p", null, "I was the sole developer for this project. I also gave their bigcommerce store a css update to match the wordpress site's brand.")),
  import_react.default.createElement(Project, {
  ...
  }, import_react.default.createElement("p", null, "I worked on the PHP page templates and css mobile, tablet, and desktop breakpoints for the whole site."))
];

// ts/components/carousel/controls.tsx
var import_react2 = __toESM(require_react(), 1);
function CarouselControls() {
  const [intervalEnabled, setIntervalEnabled] = import_react2.useState(false);
  const [intervalId, setIntervalId] = import_react2.useState(null);
  const { state, dispatch } = import_react2.useContext(CarouselContext);
  const {
    playAnimations,
    trackState,
    intervalDuration,
  ...
  return import_react2.default.createElement(import_react2.default.Fragment, null, import_react2.default.createElement("div", {
    className: "carousel-state-controls"
  }, import_react2.default.createElement("button", {
    className: "toggle",
    onClick: () => dispatch({ actionType: "Update", data: { playAnimations: !playAnimations } })
  }, "Toggle Animations ", playAnimations === true ? "Off" : "On")), import_react2.default.createElement("div", {
    className: "track-controls"
  }, import_react2.default.createElement("button", {
    className: "prev",
    onClick: () => shiftTrack(-1)
  }, "Previous"), import_react2.default.createElement("button", {
    className: "next",
    onClick: () => shiftTrack(1)
  }, "Next"), import_react2.default.createElement("button", {
    className: "pause",
    onClick: handleIntervalStatus
  }, intervalId !== null ? "Pause" : "Play", " Carousel")));
}

// ts/components/carousel/track.tsx
...
function CarouselTrack(props) {
  ...
  let countOfChildren = import_react3.default.Children.count(children);
  const { state, dispatch } = import_react3.useContext(CarouselContext);
  const {
    activeSlide,
    slidesToClone,
    trackState
  ...
  return import_react3.default.createElement(import_react3.default.Fragment, null, import_react3.default.createElement("div", {
    ...
    ref: trackRef
  }, [...children].map((val, idx, arr) => {
    if (idx < countOfChildren - slidesToClone)
      return;
    if (activeSlide === 0) {
      return import_react3.default.createElement("div", {
        className: "item item_clone",
        key: idx + "itemClone",
        "data-index": idx
      }, val);
    } else {
...
// ts/components/carousel/carousel.tsx
var rolloverActiveSlide = function(state, dragThresholdVector, maxVal) {
  let rollover = null;
  if (state.activeSlide + dragThresholdVector < 0) {
    rollover = state.activeSlide + dragThresholdVector + maxVal;
  } else if (state.activeSlide + dragThresholdVector > maxVal - 1) {
    rollover = (state.activeSlide + dragThresholdVector) % maxVal;
  }
  return rollover ?? state.activeSlide + dragThresholdVector;
};
var reducerHandler = function(state, action) {
...
function Carousel({
  ...
  const eventRef = import_react4.useRef(null);
  const [state, dispatch] = import_react4.useReducer(reducerHandler, CarouselDefaults);
  const {
    activeSlide,
    carouselResetTimer,
    deadZone,
  ...
  if (playAnimations && carouselResetTimer === null && (trackState === trackStateTitle["Playing"] || trackState === trackStateTitle["Shift"]) && carouselRef.current && trackRef.current) {
    const CAROUSEL = carouselRef.current;
  ...
  function delegatedMoveHandler(e) {
    ...
    if (trackState === trackStateTitle["Moving"] || trackState === trackStateTitle["Grabbed"]) {
      ...
      if (track2 && dragDistance2 > deadZone || track2 && dragDistance2 < deadZone * -1) {
        track2.style.translate = `${dragDistance2 + negativeOffsetOrigin}px`;
      } else {
        track2.style.translate = `${negativeOffsetOrigin}px`;
      }
    }
  }
  const [isEventRefSet, setIsEventRefSet] = import_react4.useState(false);
  ...
  function release(e) {
    ...
    if (playAnimations && (dragDistance > deadZone || dragDistance < deadZone * -1)) {
      const dragThreshold = (threshold = trackRef.current.children[1].offsetLeft) => {
        ...
        } else if (state.activeSlide + dragThresholdVector > countOfChildren - 1) {
          rollover = (state.activeSlide + dragThresholdVector) % countOfChildren;
        }
        return rollover ?? state.activeSlide + dragThresholdVector;
      };
  ...
  import_react4.useEffect(() => {
    if (negativeOffsetOrigin === 0 && trackState === trackStateTitle["Initialize"] && trackRef.current !== null) {
      const playAnimations2 = window.matchMedia("(prefers-reduced-motion: reduce)").matches === true ? false : true;
  ...
  return import_react4.default.createElement(import_react4.default.Fragment, null, import_react4.default.createElement("div", {
    id: "dev-info"
  }, playAnimations === true && import_react4.default.createElement("h2", null, "State: ", trackStateTitle[state.trackState]), import_react4.default.createElement("p", null, "Active Slide: ", state.activeSlide, " "), import_react4.default.createElement("h2", null, "Drag Distance:", dragDistance < deadZone * -1 ? "(<) " : "", ` ${dragDistance} `, dragDistance > deadZone ? " (>) " : "", trackRef.current !== null && `| DragThresholdRaw: ${dragDistance % trackRef.current.children[0].clientWidth} ` + `| DragThresholdPercent: ${Math.round(dragDistance / trackRef.current.children[0].clientWidth * -1 * 100) / 100}`)), import_react4.default.createElement("div", {
    className: "carousel",
    ...
    id: "beforeCarousel",
    href: "#beyondCarousel"
  }), import_react4.default.createElement(CarouselContext.Provider, {
...
// ts/components/project/project.tsx
var import_react5 = __toESM(require_react(), 1);
var projectStateEnum;
(function(projectStateEnum2) {
  projectStateEnum2[projectStateEnum2["Closed"] = 0] = "Closed";
  projectStateEnum2[projectStateEnum2["Open"] = 1] = "Open";
...
function Project({
  ...
  const [projectState, setProjectState] = import_react5.useState(projectStateEnum["Closed"]);
  ...
  return import_react5.default.createElement(import_react5.default.Fragment, null, import_react5.default.createElement("article", {
    className: classes,
    onClick: () => projectExpand(),
    onMouseLeave: () => projectRevert(),
    "aria-expanded": projectState === projectStateEnum["Open"] ? true : false
  }, import_react5.default.createElement("picture", null, import_react5.default.createElement("source", {
    srcSet: `assets/media/${srcSlug}.png.webp`,
    type: "image/webp"
  }), import_react5.default.createElement("source", {
    srcSet: `assets/media/${srcSlug}.png`,
    type: "image/png"
  }), import_react5.default.createElement("img", {
    src: `assets/media/${srcSlug}.png.webp`,
    alt: alt ?? ""
  })), import_react5.default.createElement("div", {
    className: "content"
  }, import_react5.default.createElement("h3", null, title, " ", import_react5.default.createElement("span", null, subtitle)), children, import_react5.default.createElement("a", {
    className: "btn",
    href: btn_href,
    target: "_blank"
  }, "Visit ", title))));
...
// ts/main.tsx
function App() {
  return import_react6.default.createElement(import_react6.default.Fragment, null, import_react6.default.createElement(import_react6.default.StrictMode, null, import_react6.default.createElement(Carousel, null, Projects)));
}

// client.tsx
client.hydrateRoot(document.getElementById("ssr-outlet"), import_react7.default.createElement(App, null));
