...
import dom, { act, cleanup, getNodeText, render, renderHook, fireEvent, screen, waitFor, waitForElementToBeRemoved } from '@testing-library/react';
...
describe('Carousel initialization', async () => {
    ...
    test('with autoplay', async () => {
        ...
        expect( await waitFor(() => view.getByRole('region').attributes.getNamedItem('aria-label')?.nodeValue ) ).toMatch('Projects Carousel with autoplay')
    });
